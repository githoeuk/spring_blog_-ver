-- User 테이블 데이터 (5명 모두 '1234' 암호화 값 적용)
INSERT INTO user_tb (username, password, email, created_at)
VALUES ('admin', '$2a$10$P/7pu5bD0qMvw2ozkhXIzu1Jqa53LNa5zlsLBot3tr0/CUUapQypK', 'admin@blog.com', NOW()),
...
VALUES ('ADMIN', 1),
       ('USER', 1), -- 1번 유저 권한 (ADMIN ,USER 둘 다 가지고 있도록 설정
       ('USER', 2),
       ('USER', 3),
       ('USER', 4),
       ('USER', 5);
...
INSERT INTO reply_tb (comment, board_id, user_id, created_at)
VALUES ('문제 추천 감사합니다! 바로 풀어보겠습니다.', 6, 1, NOW()),
       ('백준 문제 중에서 어떤 걸 먼저 풀어보면 좋을까요?', 6, 4, NOW());

-- 7번 게시글 (cos의 'React vs Vue 비교')에 대한 댓글
INSERT INTO reply_tb (comment, board_id, user_id, created_at)
VALUES ('React 쪽이 더 인기가 많은 것 같긴 하네요.', 7, 1, NOW()),
